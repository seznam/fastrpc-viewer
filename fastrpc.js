...
function _decodeUTF8(length) {
	...
	while (1) {
		...
		if (c < 128) {
			...
			if (cp >= 55296 && cp <= 56319) { exports.surrogateFlag = 1; }
 ...
 */
function serializeCall(method, data, hints) {
